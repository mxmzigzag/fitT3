...
import type { SquaredIconProps } from "./icon.types";

function SpinnerIcon({ size = 24, className = "" }: SquaredIconProps) {
  return (
    <svg
      height={size}
      width={size}
    ...
    >
      ...
      <g filter="url(#ldio-lekxg00cvtp-filter)">
        <animateTransform
